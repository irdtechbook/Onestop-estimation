...
ここで重要なのは@<b>{ふりかえりによる改善の対象となりやすい}ということです。1点見積もりで見積もりより実績が少なくなった場合は、誰かが「見積もりより小さいことは問題だ」といわなければ改善の対象になりにくいでしょう。ですが、2点見積もりでは最小と最大のふたつの定義があることによって、実績が最小と最大のあいだのどの位置にあたるのかを考えやすくなります。そのため、強く意識しなくてもふりかえりがしやすいです。

 * 見積もり精度を上げやすい

前述のふりかえりの話にも関連していますが、ふりかえり結果から見積もり精度を上げやすいのも特徴です。1点見積もりでは、実績が見積もりを上回ったか、下回ったかのどちらかしかありません。2点見積もりでは最小以下、最小と最大の間、最大以上の大きく三つに分かれます。また最小と最大の間でも、最小寄りなのか最大寄りなのかによって次の行動を変えられます。これだけ評価軸を増やせるのは、2点見積もりを用いる利点です。

たとえば1点見積もりでは、実績が見積もりを超過した場合の対応はまちまちでしょう。「まぁ見積もりだからねー仕方ない」と言って特に何も対応しないケースもあるでしょうし、「じゃあ次回から少し見積もりを増やそうか」みたいな表面的な対応にしかならないケースもありえます。

しかし、2点見積もりでは見積もりの定義が明確です。最大見積もりの定義は「そのタスクが確実に完了できる工数」なので、確実に完了できる工数を超過していることになります。そのため、事前に検討できていない項目があったのではないか、見積もり内容に問題があったのではないか、タスク消化中に非常に大きな問題が発生したのではないか、など単に不確実な1点見積もりを超過した場合に比べて考えやすいでしょう。
...
特にふりかえる際のコミュニケーションが楽になります。見積もりをしたときに、「その見積もりがどういう定義の見積もりなのか」をふりかえりのときにはよく覚えていないことも多いです。実際問題として、個々の見積もりひとつひとつに対して、マージンが多めだったかどうか、ギリギリの見積もりだったかどうかなど、いちいち覚えていられません。特に自分の見積もりならまだしも、他の人も含めてその定義を確認して管理していくのは非常に骨が折れます。

その点、2点見積もりなら最初から定義が決まっているので、過去のことを思い出す必要はありません。決められた定義のまま扱えば大丈夫です。チーム内や組織内でコミュニケーションを取るときにも、認識の違いが起こることはありません。勘違いや前提の違いで手戻りが発生しにくいのはよいポイントです。見積もり自体が不確実なものなのに、それを運用する中に不確実性があると非常に大変です。少しでも不確実性が減らせると、よりよい見積もりができるようになります。
...
ただし、チームメンバーに対して単純に2点見積もりの採用を伝えようとすると、うまくいかないことがあります。単に2点で見積もった内容だけを伝えると、「いつもの見積もりにマージンを足しているだけ」と受け取られてしまい、変わり映えがしないものに見えてしまいます。そのため2点見積もりをチーム内に伝える時は、方法や定義よりも「今現在のチームに対してどういったメリットがあるか」を伝えた方がよいです。もちろん、まずは自分で試してみて実感してみるのが大切です。

 : モチベーションの持続
見積もりを正確に行い続けることはできません。どんなに経験を積んでも、ズレる時はズレます。特に完璧主義の人（またはその傾向がある人）は、外れることがあると分かっていても気にしてしまい、ストレスを感じるものです。特に1点見積もりは1点しかないので、ピッタリと一致することはまずありません。多少ズレてしまった見積もりを、「ほぼピッタリだった」と自分を慰めた経験がある方も多いでしょう。そうしてズレることに慣れていくと、見積もりをする意義が見出せなくなっていきます。そして、自分のための見積もりというよりも、「いわれたから提出するため」だけの無意味な儀式や数字遊びになっていってしまいます。

2点見積もりは、最初からブレることを前提にしています。つまり最小見積もりと最大見積もりという2点を取るため、その間に入れば「まずは想定通り」となります。つまり見積もりとしては、高い確率で自分の想定通りとなる仕組みです。そういう意味で、大幅に外れることが少ないので、見積もりに対して高いモチベーションを保つことができます。また、最小見積もりをストレッチ目標として意識することで、より正確な最小見積もりを出すモチベーションにもなります。すぐ到達できる目標よりも、できそうでできないレベルの方がモチベーションは維持しやすいです。
...
では逆に、欠点についてもお伝えします。とはいっても、欠点というほどの欠点は思いつきませんでした。やってみる前は単純に見積もり作業が2倍になるのかと思っていましたが、そんなことはありませんでした。1点見積もりも2点見積もりも、最初にその作業が完了するまでに必要な最小限の工数を考えます。そこからマージンや不安な部分を加味した見積もりにします。これは、1点見積もりでも不完全ながら2点見積もりのようなことをやっていたということです。そのため、筆者の場合は作業量が2倍になるということはありませんでした。最小工数を出すために細かくタスクの分割などをするようになりましたが、これはより正確な見積もりを出すために必要なので、欠点とまではいえないでしょう。
...
見積もりをしていて、こんなことをいわれたことはないでしょうか。そんな質問に対して、これまでは明確な根拠もなく、今までの経験で乗り切ってきました。ですが、2点見積もりとふりかえりを続けることで、こんな質問にもこう答えられるようになります。
...
見積もりに対して、これらを逐一記録していきましょう。面倒だし続けるのはかなり億劫ですが、ふりかえりによる効果を享受するには必要な作業です。次のように工夫して、継続してやっていくようにしましょう。
...
=== 筆者の事例
 ...
 : 調査タスクも見積もりしよう
    　調査は結果が出るか出ないわからないので見積もりしないケースがありますが、筆者は見積もりをしたほうがよいです。
 ...
 : 上手く行ったときの知見も貯めればよかった
    　見積もりがズレたときにしかその理由を考えていなかったので、正しい見積もりを再現する知見が溜まりづらい環境となっていました。
    また、そういった知見が溜まらなかったため、チーム内へのフィードバックも積極的にできていませんでした。

 : もっと自分に対してもチームに対しても見える化すべきだった
    　2点見積もりをやっていることはチーム内に伝えていましたが、グラフや色分けした表を見せることでメリットを伝えたほうが良かったです。
    またそういったアウトプットを通して課題や問題点に気づけたりするので、チーム内に対しての定期的なアウトプットはするべきでした。
